...
class LogicExpression_determineExpressionType_NORMAL_Test {
    ...
    void testDetermineLogicExpressionType() throws Exception {
        // Define SUPPORTED_OPERATORS for logical operators
        ...
        assertEquals("postfix", invokeDetermineExpressionType("A B NOT AND", SUPPORTED_OPERATORS), "Expected postfix notation.");
        assertEquals("infix", invokeDetermineExpressionType("(A AND (B OR C))", SUPPORTED_OPERATORS), "Expected infix notation.");
        assertEquals("infix", invokeDetermineExpressionType("A AND (B OR", SUPPORTED_OPERATORS), "Expected unknown notation due to unbalanced parentheses.");
    }
}
